...
{
    public partial class FirstTableMensagemAndEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenssageChatUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenssageChatUsers_MessageChats_MensagemId",
                        column: x => x.MensagemId,
                        principalTable: "MessageChats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenssageChatUsers_MensagemId",
